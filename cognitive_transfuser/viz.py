...
parser.add_argument('--model_path', type=str, default='model_ckpt/transfuser/', help='path to model ckpt')
parser.add_argument('--device', type=str, default='cuda', help='Device to use')
parser.add_argument('--batch_size', type=int, default=10, help='Batch size')
parser.add_argument('--save_path', type=str, default='./viz', help='path to save visualizations')
